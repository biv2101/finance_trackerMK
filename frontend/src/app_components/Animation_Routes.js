...
import Log_in_Page from "../navbar_components/Log_in_Page";
import Sign_up_Page from "../navbar_components/Sign_up_Page";
...
import Markets from "../menu_components/markets_news/Markets";
...
export default function Animation_Routes(){
    ...
    return(
        ...
        <Routes location={location} key={location.pathname}>
            ...
            <Route path="log_in" element={<Log_in_Page/>}/>
