...
def getStockInfo(ticker):
    ...
    dailydata = get_data(ticker, start_date="01/01/2023", end_date=None, index_as_date=False, interval="1d")
    connection = connect('symbolsprices.db')
    curs1 = connection.cursor()
    ...
    query = 'CREATE TABLE IF NOT EXISTS ' + tick + ' (time timestamp, close FLOAT);'
