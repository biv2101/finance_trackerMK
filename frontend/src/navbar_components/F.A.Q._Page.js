...
export default function FAQ_Page(){
    ...
    const randomNumber_1 = Math.floor(Math.random() * questions.length);
    ...
    return(
        <motion.div className="faq_body">
            <div className="faq_accordion">
                <div className="image_box">
                    <img src={require('../images/images_png/questionmarks.png')} className="faq_image" alt="faq_picture"/>
                </div>
                ...
                <Plus className="faq_plus" onClick={()=>toggle(randomNumber)}/>
            </div>
        </motion.div>
    )
}
